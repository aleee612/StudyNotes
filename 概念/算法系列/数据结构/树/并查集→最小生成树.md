...
3. 每个元素自成一个集合
#### Find
1. 沿父节点寻找根结点（`parent[x]==x`）
2. 返回集合代表元
3. 路径压缩：`parent[x]=find(parent[x])`
作用：缩短路径，提高查找效率
#### Union
1. 求两个元素的根结点
2. 根不同则合并
3. 按秩合并（矮树挂高树，高度相同则根的秩+1）
作用：保持树平衡
#### 优化
| 优化方法 | 作用         |
| ---- | ---------- |
...
同时使用时：
```
Find ≈ O(1)Union ≈ O(1)+0
```
严格复杂度：
```
O(α(n))
```
其中 α(n) 为反 Ackermann 函数
...
![124](https://cdn.nlark.com/yuque/0/2025/png/55555653/1744542180269-0f416cc3-d644-4f7b-924b-4cd33b58d065.png "null")
假设我们给所有的权值编号，由小到大依次为a b c d e f g h：
![134](https://cdn.nlark.com/yuque/0/2025/png/55555653/1744542180382-adca3865-5a7c-4fd1-93f7-6017511f9dd0.png "null")
...
#### 题目练习：
- p1194买礼物
![233](https://cdn.nlark.com/yuque/0/2025/png/55555653/1744542180547-50002cd0-1ce2-4253-b3ad-c70a8916537d.png "null")![208](https://cdn.nlark.com/yuque/0/2025/png/55555653/1744542180619-1d907965-e149-4960-9d00-a1797cc8c83f.png "null")
```cpp fold
#include <iostream>
#include <vector>
#include <algorithm>
